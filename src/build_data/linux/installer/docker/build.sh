...
for architecture_platform in amd64,linux/amd64 i386,linux/386 arm32v7,linux/arm/v7 arm64v8,linux/aarch64; do
    architecture=$(echo ${architecture_platform} | cut -d "," -f 1)
    platform=$(echo ${architecture_platform} | cut -d "," -f 2)
