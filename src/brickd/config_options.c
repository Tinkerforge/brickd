...
ConfigOption config_options[] = {
	...
	CONFIG_OPTION_INTEGER_INITIALIZER("listen.mesh_gateway_port", 0, UINT16_MAX, 4240),
...
#endif
#ifdef BRICKD_WITH_BRICKLET
	CONFIG_OPTION_INTEGER_INITIALIZER("bricklet.portA.sleep_between_reads", 100, 1000000, 200), // microseconds
	CONFIG_OPTION_INTEGER_INITIALIZER("bricklet.portB.sleep_between_reads", 100, 1000000, 200), // microseconds
	CONFIG_OPTION_INTEGER_INITIALIZER("bricklet.portC.sleep_between_reads", 100, 1000000, 200), // microseconds
	CONFIG_OPTION_INTEGER_INITIALIZER("bricklet.portD.sleep_between_reads", 100, 1000000, 200), // microseconds
	CONFIG_OPTION_INTEGER_INITIALIZER("bricklet.portE.sleep_between_reads", 100, 1000000, 200), // microseconds
	CONFIG_OPTION_INTEGER_INITIALIZER("bricklet.portF.sleep_between_reads", 100, 1000000, 200), // microseconds
	CONFIG_OPTION_INTEGER_INITIALIZER("bricklet.portG.sleep_between_reads", 100, 1000000, 200), // microseconds
	CONFIG_OPTION_INTEGER_INITIALIZER("bricklet.portH.sleep_between_reads", 100, 1000000, 200), // microseconds
	...
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group0.cs0.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group0.cs1.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group0.cs2.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group0.cs3.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group0.cs4.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group0.cs5.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group0.cs6.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group0.cs7.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group0.cs8.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group0.cs9.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group1.cs0.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group1.cs1.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group1.cs2.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group1.cs3.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group1.cs4.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group1.cs5.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group1.cs6.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group1.cs7.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group1.cs8.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
	CONFIG_OPTION_STRING_INITIALIZER("bricklet.group1.cs9.name", 0, BRICKLET_CS_NAME_MAX_LENGTH, NULL),
#endif
